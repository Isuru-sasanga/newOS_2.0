;*****************start of the newOS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to newOS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO newOS ************', 0x00 

	wel4 db ' Based on Josh', 0x00

	wel5 db ' By Dr.Mohan Raj Dhanagopal', 0x00

	wel6 db ' Bootloader - Ultimate Boot Loader - Matthew Vea', 0x00

	wel7 db ' version 1.0.0 of newOS From I.S.KOLAMBAGE - SE/2019/038', 0x00
